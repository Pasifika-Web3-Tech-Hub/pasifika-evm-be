...
contract PasifikaNFTTest is Test {
    ...
    function test_MintNFT() public {
        ...
        // Verify token URI
        assertEq(nft.tokenURI(tokenId), "https://pasifika.io/metadata/ipfs://QmZ1Hg8dXm4nHUsyQXQXe8g5HCPxpXsXF3Kxnfm8NZ6hXH");
    ...
    function test_PhysicalItemMint() public {
        ...
        uint256 tokenId = nft.mint(
            creator,
            "ipfs://QmPhysical123456789",
            PasifikaNFT.ItemType.Physical,
            defaultRoyaltyPercent,
            physicalDetails
        );
        ...
        assertEq(uint(itemType), uint(PasifikaNFT.ItemType.Physical));
    ...
    function test_UpdateBaseURI() public {
        ...
        assertEq(nft.tokenURI(tokenId), "https://new.pasifika.io/nft/ipfs://QmZ1Hg8dXm4nHUsyQXQXe8g5HCPxpXsXF3Kxnfm8NZ6hXH");
    }
