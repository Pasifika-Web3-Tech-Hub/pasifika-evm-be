...
contract PasifikaMoneyTransferTest is Test {
    ...
    function testDirectTransfer() public {
        ...
        assertEq(moneyTransfer.pendingWithdrawals(recipient), expectedRecipientAmount, "Recipient should have pending withdrawal");
        ...
        assertEq(recipient.balance - recipientBalanceBefore, expectedRecipientAmount, "Recipient should have received correct amount");
    }
    ...
    function testMemberDiscount() public {
        ...
        assertEq(moneyTransfer.pendingWithdrawals(recipient), expectedRecipientAmount, "Recipient should have correct pending withdrawal with member discount");
    }
